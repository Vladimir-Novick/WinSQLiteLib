...
TEST_METHOD(StatementmoveConstructor)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE | SQLite::OPEN_CREATE);
    EXPECT_EQ(0, db.exec("CREATE TABLE test (id INTEGER PRIMARY KEY, value TEXT)"));
...
TEST_METHOD(StatementexecuteStep)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE|SQLite::OPEN_CREATE);
    EXPECT_EQ(SQLite::OK, db.getErrorCode());
...
TEST_METHOD(StatementtryExecuteStep)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE|SQLite::OPEN_CREATE);
    EXPECT_EQ(SQLite::OK, db.getErrorCode());
...
TEST_METHOD(StatementbindNoCopy)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE|SQLite::OPEN_CREATE);
    EXPECT_EQ(SQLite::OK, db.getErrorCode());
...
TEST_METHOD(StatementbindByName)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE|SQLite::OPEN_CREATE);
    EXPECT_EQ(SQLite::OK, db.getErrorCode());
...
TEST_METHOD(StatementbindByNameString)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE | SQLite::OPEN_CREATE);
    EXPECT_EQ(SQLite::OK, db.getErrorCode());
...
TEST_METHOD(StatementbindNoCopyByName)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE|SQLite::OPEN_CREATE);
    EXPECT_EQ(SQLite::OK, db.getErrorCode());
...
TEST_METHOD(StatementisColumnNull)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE|SQLite::OPEN_CREATE);
    int code = db.getErrorCode();
    EXPECT_EQ(SQLite::OK, db.getErrorCode());
    ...
    EXPECT_EQ(1, db.exec("INSERT INTO test VALUES (\"first\", 123,  0.123)"));
    EXPECT_EQ(1, db.exec("INSERT INTO test VALUES (NULL,      123,  0.123)"));
    EXPECT_EQ(1, db.exec("INSERT INTO test VALUES (\"first\", NULL, 0.123)"));
    EXPECT_EQ(1, db.exec("INSERT INTO test VALUES (\"first\", 123,  NULL)"));
...
TEST_METHOD(StatementisColumnNullByName)
{
    // Create a new database
...
TEST_METHOD(StatementgetColumnByName)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE|SQLite::OPEN_CREATE);
    EXPECT_EQ(SQLite::OK, db.getErrorCode());
...
TEST_METHOD(StatementgetColumnDeclaredType)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE | SQLite::OPEN_CREATE);
...
TEST_METHOD(StatementgetColumns)
{
...
TEST_METHOD(Statementbind64bitsLong)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE|SQLite::OPEN_CREATE);
    EXPECT_EQ(SQLite::OK, db.getErrorCode());
...
TEST_METHOD(StatementgetBindParameterCount)
{
    // Create a new database
    SQLite::Database db(":memory:", SQLite::OPEN_READWRITE | SQLite::OPEN_CREATE);
    EXPECT_EQ(0, db.exec("CREATE TABLE test (id INTEGER PRIMARY KEY, msg TEXT)"));
